...
/**
 * Thrown when a folder cannot be opened in the file manager. The caller is
 ...
 */
public class FolderOpenException extends Exception {
    /**
     ...
     */
    public FolderOpenException(String message, @Nullable Throwable cause) {
